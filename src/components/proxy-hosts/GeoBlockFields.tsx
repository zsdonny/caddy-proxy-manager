                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="col-span-1">
                      ...
                      <Input
                        ...
                        placeholder={showModeSelector ? "Default: 403" : "403"}
                        className="h-8 text-sm"
                      />
                      <p className="text-xs text-muted-foreground mt-1">{showModeSelector ? "Uses global setting if set, otherwise 403" : "HTTP status when blocked"}</p>
                    </div>
                    <div className="col-span-2">
                      ...
                      <Input
                        ...
                        placeholder={showModeSelector ? "Default: Forbidden" : ""}
                        className="h-8 text-sm"
                      />
                      <p className="text-xs text-muted-foreground mt-1">{showModeSelector ? "Uses global setting if set, otherwise Forbidden" : "Body text returned to blocked clients"}</p>
                    </div>
                    <div className="col-span-3">
                      ...
                      <Input
                        ...
                        placeholder={showModeSelector ? "None (uses global if set)" : "https://example.com/blocked"}
                        className="h-8 text-sm"
                      />
                      <p className="text-xs text-muted-foreground mt-1">{showModeSelector ? "Uses global setting if set. Sends a 302 redirect instead of status/body" : "If set, sends a 302 redirect instead of status/body above"}</p>
                    </div>
                  </div>
